...
import {
  ...
  UserPlus, BarChart3, Star, CheckCircle2, Shield
} from 'lucide-react';
...
const features = [
  ...
  { icon: UserPlus, title: 'Recruitment', desc: 'End-to-end recruitment pipeline from job posting to onboarding.' },
...
const testimonials = [
  {
    ...
    text: 'HRFlow transformed our HR operations. What used to take days now takes minutes. The automation is incredible.',
    rating: 5,
  },
  {
    name: 'Marcus Johnson',
  ...
  },
  {
    ...
    role: 'COO, DataSync',
    text: 'We reduced HR admin time by 70% after switching to HRFlow. It\'s been a game-changer for our growing team.',
    rating: 5,
  },
];

const plans = [
  { name: 'Starter', price: 29, features: ['Up to 25 employees', 'Basic attendance', 'Leave management', 'Email support'] },
  { name: 'Business', price: 79, features: ['Up to 200 employees', 'Advanced analytics', 'Payroll processing', 'Priority support', 'API access'], popular: true },
  { name: 'Enterprise', price: 199, features: ['Unlimited employees', 'Custom integrations', 'Dedicated manager', '24/7 phone support', 'SLA guarantee', 'On-premise option'] },
];
  ...
  return (
    <div className="overflow-hidden">
      ...
      <section className="relative min-h-[100svh] overflow-hidden bg-white">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_58%_46%_at_50%_0%,rgba(239,68,68,0.16),transparent_72%)]" />
        ...
        <div className="relative mx-auto grid min-h-[100svh] max-w-7xl items-center gap-12 px-5 pb-16 pt-28 sm:px-6 sm:pt-32 lg:grid-cols-2 lg:gap-16 lg:px-8 lg:pb-0 lg:pt-32">
          <div className="text-left">
            <motion.p
              ...
              className="inline-flex items-center gap-2 rounded-full border border-red-200 bg-white px-4 py-1.5 text-[11px] font-bold uppercase tracking-[0.2em] text-red-600 shadow-sm"
            >
              Pre-launch access by NexusLabs
            </motion.p>
            ...
            >
              ...
              <span className="text-red-600">for Modern Teams</span>
            </motion.h1>
            ...
            >
              Run employee operations, attendance, leave, payroll, recruitment, and performance from a single workspace built for speed and clarity.
            </motion.p>
            ...
            >
              <Link
                to="/pricing"
                className="gradient-primary inline-flex items-center justify-center rounded-full px-10 py-4 text-base font-bold text-white shadow-lg shadow-red-500/20 transition-all hover:-translate-y-0.5 hover:shadow-xl hover:shadow-red-500/30"
              >
                Join Waitlist
              </Link>
              <Link
                to="/contact"
                className="inline-flex items-center justify-center rounded-full border-2 border-gray-100 px-10 py-4 text-base font-bold text-gray-900 transition-all hover:-translate-y-0.5 hover:border-red-100 hover:bg-red-50"
              >
                Book Demo
              </Link>
            </motion.div>
          ...
          >
            <motion.div
              ...
              className="absolute h-[18rem] w-[18rem] rounded-full border border-red-100 sm:h-[22rem] sm:w-[22rem]"
            />
            <motion.div
              animate={{ rotate: -360 }}
              transition={{ duration: 42, repeat: Infinity, ease: 'linear' }}
              className="absolute h-[13rem] w-[13rem] rounded-full border border-red-200/80 sm:h-[16rem] sm:w-[16rem]"
            />

            <div className="absolute h-2.5 w-2.5 rounded-full bg-red-500" />
            <div className="absolute h-1.5 w-1.5 -translate-x-[9rem] -translate-y-[2rem] rounded-full bg-red-300 sm:-translate-x-[11rem]" />
            <div className="absolute h-1.5 w-1.5 translate-x-[8.5rem] translate-y-[3rem] rounded-full bg-red-300 sm:translate-x-[10.5rem]" />
            ...
            <div className="w-full max-w-sm space-y-6">
              {[
                ...
                >
                  ...
                  <span className="h-px w-20 bg-gradient-to-r from-red-200 to-transparent sm:w-24" />
                </motion.div>
              ))}
            </div>
          </motion.div>
            ...
            <div>
              <AnimatedSection>
                ...
                <p className="mt-4 text-lg text-gray-600 leading-relaxed">
                  From onboarding to offboarding, HRFlow provides a unified platform that automates repetitive tasks and empowers your HR team to focus on what matters most — your people.
                </p>
              </AnimatedSection>
              ...
              <AnimatedSection delay={0.3}>
                <Link
                  to="/features"
                  className="mt-8 inline-flex items-center gap-2 text-red-600 font-semibold hover:text-red-700 transition-colors"
                >
            ...
            {features.map((feature, i) => (
              <AnimatedSection key={feature.title} delay={i * 0.1}>
                <motion.div
                  ...
                  className="group glass-card rounded-2xl p-8 transition-all hover:shadow-xl hover:shadow-red-500/10"
                >
                  <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-red-50 to-red-100 group-hover:from-red-500 group-hover:to-red-600 transition-all duration-300">
                    <feature.icon className="h-7 w-7 text-red-600 group-hover:text-white transition-colors duration-300" />
                  </div>
              ...
              <AnimatedSection key={t.name} delay={i * 0.1}>
                <div className="glass-card rounded-2xl p-8 h-full">
                  ...
                  <div className="mt-6 flex items-center gap-3">
                    <div className="flex h-11 w-11 items-center justify-center rounded-full bg-gradient-to-br from-red-400 to-red-600 text-white font-bold text-sm">
              ...
              <AnimatedSection key={plan.name} delay={i * 0.1}>
                <motion.div
                  ...
                  className={`relative rounded-3xl p-8 h-full flex flex-col ${
                    plan.popular
                      ? 'gradient-primary text-white shadow-2xl shadow-red-500/25 ring-4 ring-red-500/20'
                      : 'glass-card'
                  }`}
                >
                  {plan.popular && (
                    <div className="absolute -top-4 left-1/2 -translate-x-1/2 rounded-full bg-white px-4 py-1 text-xs font-bold text-red-700 shadow-lg">
                      Most Popular
                    </div>
                  )}
                  ...
                  <ul className="mt-6 flex-1 space-y-3">
                    {plan.features.map((f) => (
                      <li key={f} className="flex items-center gap-2">
                        <CheckCircle2 className={`h-4 w-4 flex-shrink-0 ${plan.popular ? 'text-white/80' : 'text-red-500'}`} />
        ...
        <div className="relative mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
          <AnimatedSection>
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg text-white/80">
              Be among the first to experience HRFlow when we launch. Join the waitlist and get early access with exclusive pricing.
            </p>
            <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
              <Link
                to="/pricing"
                className="inline-flex items-center gap-2 rounded-2xl bg-white px-8 py-4 text-base font-semibold text-red-700 shadow-xl transition-all hover:bg-gray-50 hover:-translate-y-1 hover:shadow-2xl"
              >
                Join Waitlist
